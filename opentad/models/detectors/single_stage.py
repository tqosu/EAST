...
class SingleStageDetector(BaseDetector):
    ...
    def post_processing(self, predictions, metas, post_cfg, ext_cls, **kwargs):
        ...
        # print("# location 1")
        # print(type(rpn_proposals[0]),type(rpn_scores[0]),type(ext_cls[0]))
        # print(rpn_proposals[0].shape,rpn_scores[0].shape,len(ext_cls))
        ...
        # print(rpn_proposals[0].shape,rpn_scores[0].shape,\
        #       len(ext_cls),num_classes)
        # return 
        results = {}
