...
class LadderNetwork(BaseModule):
    ...
    def forward(self, feat_list: List[Tensor], h, w, adapter_index1: List[int]) -> Tensor:
        # the last feature map is the original output of the backbone
        output = feat_list[-1]
        for i in range(self.depth):
            if i not in adapter_index1:
...
class VisionTransformerLadder1(BaseModule):
    ...
    def __init__(
        ...
        adapter_index1: Optional[List[int]] = list(),
        ...
        **kwargs,
        ...
        self.adapter_index1 = adapter_index1
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # ladder network
        out = self.ladders(feat_list, h, w, self.adapter_index1)
