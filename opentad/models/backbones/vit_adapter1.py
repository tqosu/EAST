...
class Block(BaseModule):
    ...
    def forward(self, x: Tensor, h, w, use_adapter: bool = True) -> Tensor:
        """Defines the computation performed at every call.
        ...
        def _inner_forward(x):
            ...
            if self.use_adapter and use_adapter:
...
class VisionTransformerAdapter1(BaseModule):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        for i, blk in enumerate(self.blocks):
            x = blk(x, h, w, use_adapter=i not in self.adapter_index1)
