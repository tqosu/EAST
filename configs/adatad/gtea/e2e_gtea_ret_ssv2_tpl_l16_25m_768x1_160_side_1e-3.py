...
work_dir = "exps/gtea/adatad/e2e_actionformer_ret_ssv2_tpl_l16_25m_768x1_160_side_1e-3"
metr_path = "epoch_metrics_mAP.csv"

optimizer = dict(backbone=dict(custom=[dict(name="adapter", lr=1e-3, weight_decay=0.05)]))
