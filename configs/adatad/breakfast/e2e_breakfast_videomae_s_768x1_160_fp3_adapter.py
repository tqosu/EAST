_base_ = [
    "../../_base_/datasets/breakfast/e2e_train_trunc_test_fps3_sw_256x224x224.py",  # dataset config
    "../../_base_/models/actionformer_breakfast.py",  # model config
]
...
work_dir = "exps/breakfast/adatad/e2e_actionformer_videomae_s_768x1_160_fps3_adapter_2e-4"
