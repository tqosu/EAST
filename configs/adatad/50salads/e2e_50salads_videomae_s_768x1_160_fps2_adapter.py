_base_ = [
    "../../_base_/datasets/50salads/e2e_train_trunc_test_fps2_sw_256x224x224.py",  # dataset config
    "../../_base_/models/actionformer_50salads.py",  # model config
]
...
work_dir = "exps/50salads/adatad/e2e_actionformer_videomae_s_768x1_160_fps2_adapter"
