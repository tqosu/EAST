annotation_path = "data/50salads/annotations/50salads.split1.json"
class_map = "data/50salads/annotations/50salads_category_idx.txt"
data_path = "data/50salads/raw_data/video"
block_list = None
...
dataset = dict(
    train=dict(
        ...
        sample_stride=sample_stride,  # 1x2=2
        pipeline=[
    ...
    test=dict(
        ...
        # thumos dataloader setting
        feature_stride=feature_stride,
        sample_stride=sample_stride,  # 2x4=8
        window_size=window_size,
